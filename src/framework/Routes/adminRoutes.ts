...
adminRoutes.post(
  "/addPlan",
  authorizationMiddleware,
  adminController.addPricingPlan.bind(adminController)
);
adminRoutes.get(
  "/getPlan",
  authorizationMiddleware,
  adminController.getPricingPlans.bind(adminController)
);
adminRoutes.put(
  "/updatePlan",
  adminController.editPricingPlan.bind(adminController)
);
adminRoutes.delete(
  "/deletePlan",
  authorizationMiddleware,
...
adminRoutes.get(
  "/getAllSubscribers",
  authorizationMiddleware,
  adminController.getAllSubscribers.bind(adminController)
);
adminRoutes.get(
  "/getDataCounts",
  authorizationMiddleware,
  eventController.getDataCounts.bind(eventController)
);
adminRoutes.get(
  "/getDashboardData",
  authorizationMiddleware,
